...
- [ ] Initialize Tauri v2 + React (TS) environment.
- [ ] Implement basic Rust command to read local `.md` files.
- [ ] Create a dual-pane layout: Sidebar (TOC) and Main Content.

## Phase 2: Structural Intelligence
- [ ] Implement AST-based parsing in Rust to detect heading levels and list depths.
- [ ] Pass structured JSON data to the frontend for granular rendering.
- [ ] Add Sticky Breadcrumb navigation at the top of the viewport.
